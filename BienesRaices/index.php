...
?>
    ...
    <section class="seccion contenedor">
      ...
      <div class="contenedor-anuncios">
        <!-- subBloque2 anuncio Lago [inicio] -->
        <div class="anuncio">
          <picture>
            <source
          ...
          <!-- subBloque3 contenido-anuncio Lago [inicio] -->
          ...
          <!-- !subBloque3 contenido-anuncio Lago [fin] -->
        </div>
        <!-- !subBloque2 anuncio Lago [fin] -->
        <!-- subBloque2 anuncio Lujo [inicio] -->
        <div class="anuncio">
          <picture>
            <source
          ...
          <!-- subBloque3 contenido-anuncio Lujo [inicio] -->
          <div class="contenido-anuncio">
            <h3>Casa terminados de lujo</h3>
            <p>casa con diseño moderno, asi como tecnología inteligente y amueblada</p>
            <p class="precio">$3,000,000</p>
            <ul class="iconos-caracteristicas">
              <li>
                <img
          ...
          <!-- !subBloque3 contenido-anuncio Lujo [fin] -->
        </div>
        <!-- !subBloque2 anuncio Lujo [fin] -->
    ...
    <footer class="footer seccion">
      ...
      <!-- subBloque2 copyright [inicio] -->
      <p class="copyrigth">Todos los derechos reservados 2025 &copy</p>
      <!-- !subBloque2 copyright [fin] -->
    </footer>
    <!-- !BLOQUE footer [fin] -->
